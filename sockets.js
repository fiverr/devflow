...
module.exports = function(nodeServer) {
    ...
    socketConn.sockets.on('connection', function (socket) {
        ...
        // On-demand Servers
        socket.setSocketEvent('createServer', server.create, 'serverCreated');
        socket.setSocketEvent('killServer', server.kill, 'serverKilled');
        socket.setSocketEvent('updateServerStatus', server.onStatusChange, 'serverStatusChanged');
    });
